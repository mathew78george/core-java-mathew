...
public class StringTest {
  ...
  public static void main(String[] args) {
    ...
    // findNumberOfVowels(str);
    testfindMostRepeatedWord();
  }

  public static void stringEqualTest(String[] args) {
    String s1 = "ABC";
    String s2 = "ABC";
  ...
  public static void findNumberOfVowels(String str) {
    ...
    System.out.println("nonVowelsCount" + nonVowelsCount);
  ...
  public static boolean isCommonWord(String item) {
    String[] commonWords = { "the", "a", "or", "an", "it", "and", "but", "is", "are", "of", "on", "to", "was", "were",
  ...
  public static void findMostRepeatedWord(String input) {
    String lowercased = input.toLowerCase().trim();
    String[] words = lowercased.split("[ \\n\\t\\r.,;:!?()]");
    Map<String, Integer> wordsCount = new HashMap<String, Integer>();

    for(String word : words) {
      if(word.length() > 0 && !isCommonWord(word)) {
    ...
    for(String aKey : wordsCount.keySet()) {
      int currentValue = wordsCount.get(aKey);
      if(currentValue > maxRepeated) {
        maxRepeated = currentValue;
        mostRepeatedWord = aKey;
      }
    }
    System.out.println("mostRepeatedWord -->" + mostRepeatedWord + "  maxRepeated count " + maxRepeated);
  }

  public static void testfindMostRepeatedWord() {
    ...
    String testString3 = "Students seek relief from rising " + "prices through the purchase of used copies of "
                         ...
                         + "book to register on the site. If the student " + "has purchased a used textbook, then "
                         + "he or she must pay money directly " + "to the publisher in order to access the "
